...
-- Crear tabla para envíos GLS (sin foreign key por ahora)
...
-- Insertar los datos de ejemplo - primero pedidos
...
('IFSES_Matri_17750', 'PROCESANDO', '2025-08-30', 'Laura Reina Pla', 'Paseo ezequiel gonzalez 32, bloque 1, planta 4, puerta D', 'Segovia', 'Curso OPE CATALUÑA_2025_1er Envío', 'laura.reina@email.com'),
('IFSES_Matri_17864', 'PROCESANDO', '2025-09-01', 'María José Martín Fraile', 'Calle GARABATO 20, bloque 5, puerta 8', 'El Sobradillo', 'Curso OPE CATALUÑA_2025_1er Envío', 'maria.martin@email.com'),
('IFSES_Matri_17877', 'ENTREGADO', '2025-09-01', 'Aileen Martín García', 'Calle General Tacoronte Tejina, 120 Bl A, 2º, I', 'Tacoronte', 'Curso OPE CATALUÑA_2025_1er Envío', 'aileen.martin@email.com');
